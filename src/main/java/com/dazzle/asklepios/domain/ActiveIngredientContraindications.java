...
@Table(name = "active_ingredient_contraindications")
public class ActiveIngredientContraindications extends AbstractAuditingEntity<Long> implements Serializable{
        @Id
