...
public class InventoryTransferAttachmentsTest {

    @Test
    void testBuilderAndGetters() {
        Instant now = Instant.now();

        InventoryTransferAttachments att = InventoryTransferAttachments.builder()
                .id(9001L)
                .transactionId(123L)
                .spaceKey("space-abc")
                .filename("report.pdf")
    ...
    void testEqualsAndHashCode() {
        InventoryTransferAttachments a1 = InventoryTransferAttachments.builder()
                .id(7001L)
                .transactionId(1L)
                .spaceKey("k")
                .filename("a.txt")
        ...
        InventoryTransferAttachments a2 = InventoryTransferAttachments.builder()
    ...
    void testSerialization() throws Exception {
        ...
        InventoryTransferAttachments copy = (InventoryTransferAttachments) in.readObject();
